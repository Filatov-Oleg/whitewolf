...
Пользователь может выбрать дату и время брони. Если посетитель выбирает дату или время менее, чем за 45 минут, и нажмет кнопку "Запросить бронирование", то появится предупреждение, что не возможно забронировать. Если пользователь выберет корректную дату и время, то появится подтверждение о бронировании. 
